        ...
        >
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-gray-700 underline dark:text-gray-500">
                            Home
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-gray-500">
                            Log in
                        </a>
            ...
            <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
                ...
                <div class="mt-8 overflow-hidden bg-white shadow sm:rounded-lg dark:bg-gray-800">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="border-t border-gray-200 p-6 md:border-t-0 md:border-l dark:border-gray-700">
                            <div class="flex items-center">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
